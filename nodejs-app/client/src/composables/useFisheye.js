    ...
    nextTick(() => {
      requestAnimationFrame(() => {
        ...
        legend.style.cssText =
          'position:absolute;top:10px;right:10px;z-index:5;background:rgba(0,0,0,0.7);padding:8px 12px;border-radius:6px;font-size:11px;color:#ccc;pointer-events:none;'
        types.forEach((type) => {
        ...
        tooltip.style.cssText =
          'position:absolute;z-index:10;pointer-events:none;background:rgba(0,0,0,0.9);color:#eee;padding:8px 12px;border-radius:6px;font-size:12px;max-width:280px;border:1px solid rgba(255,255,255,0.2);display:none;'
        ...
        nodes.map((n) => {
          ...
          return {
            ...
            color: {
              ...
              border: '#666',
              highlight: { background: '#fff', border: '#4a9eff' },
            },
